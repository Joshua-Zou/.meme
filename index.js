...
// this is for demonstration purposes only! You do not need to include this!
function example(){
    fetch("https://raw.githubusercontent.com/Joshua-Zou/.meme/main/example.meme").then(res => res.json()).then(json => {
        //let json = JSON.parse(evt.target.result);
            let outputCanvas = document.getElementById("output");
            outputCanvas.style.width = json.width + "px";
            outputCanvas.style.height = json.height + "px";
